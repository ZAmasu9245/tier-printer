...
net.Receive("opr_openui", function()
	...
	moneystat.Paint = function(self, w, h)
		...
		draw.SimpleText(string.format(TierPrinters.Config.Language.CurrentHold2, formatMoney(printer:GetMoney())), dermafont, w/2, h/2, Color(100, 200, 100), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP)
	end
